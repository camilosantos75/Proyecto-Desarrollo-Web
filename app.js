    ...
    $.getJSON(url, function(data) {
      ...
      if (meals) {
        for (var i = 0; i < meals.length; i++) {
          var meal = meals[i];
          var html = '<div class="card mb-3"><img class="card-img-top" src="' + meal.strMealThumb + '"><div class="card-body"><h5 class="card-title">' + meal.strMeal + '</h5><p class="card-text">' + '</p></div></div>';
          if (i % 2 == 0) {
            htmlColumn1 += html;
          } else {
            htmlColumn2 += html;
